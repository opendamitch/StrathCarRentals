        ...
        FirebaseFirestore.getInstance().collection("mobil")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.detailCategory.setText("Category : "+st3)
                    b.detailMerk.setText("Brand : "+st4)
                    b.detailHarga.setText("Rental Price KSH."+st9)
                    b.detailStnk.setText("Chassis No : "+st10)
                    b.detailPlat.setText("Number Plate : "+st11)
                    b.detailTahun.setText("Year of Make : "+st12)

                    //if (st5.equals("available")) {
