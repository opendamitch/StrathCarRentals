...
class BookingKonfirmasiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle("Car Confirmation")
        ...
        b.bookingBiayaSopir.setText("KSH."+result_sopir)
        ...
        FirebaseFirestore.getInstance().collection("mobil")
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    val st2 = document.get("nama").toString()
                    val st3 = document.get("Category").toString()
                    val st4 = document.get("harga").toString()

                    hrgM = st4.toInt()
                    Picasso.get().load(st1).into(b.detailFotoMobil)
                    b.bookingMobil.setText(st2)
                    b.bookingCategory.setText(st3)
                    b.bookingHarga.setText("Rental Cost KSH."+st4)

                    val hr = hr.toInt()
                    val hrgMobil = hr * hrgM
                    b.bookingHargaRental.setText("KSH."+hrgMobil)
                    totalMobil = hrgMobil.toString()

                    if (idS == "") {
                        b.bookingTotal.setText("KSH."+totalMobil)
                                ...
                                .addOnSuccessListener {
                                    ...
                                    FirebaseFirestore.getInstance().collection("mobil")
                                        ...
                                        .addOnSuccessListener {
                                            ...
                                            Toast.makeText(this, "Successfully booked a car on the date "+paket?.getString("tgl_rental").toString(), Toast.LENGTH_SHORT).show()
                                        }
                                }
                        }
                    } else {
                        val totalAkhir = totalSopir.toInt() + totalMobil.toInt()
                        b.bookingTotal.setText("KSH."+totalAkhir.toString())
