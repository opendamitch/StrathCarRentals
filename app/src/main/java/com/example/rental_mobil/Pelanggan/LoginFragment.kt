                                    ...
                                    FirebaseFirestore.getInstance().collection("pelanggan")
                                        ...
                                        .addOnSuccessListener { documents ->
                                            if (!documents.isEmpty) {
                                                ...
                                                Toast.makeText(thisParent, "Your account has been disabled by the Admin", Toast.LENGTH_SHORT).show()
                                            }
                                        }
                                }else{
                                    Toast.makeText(this.context, "Your email has not been verified", Toast.LENGTH_LONG).show()
                                }
                            }
                        }else{
                            Toast.makeText(this.context, "Username / Password is Incorrect", Toast.LENGTH_LONG).show()
                        }
                    }
            } else {
                Toast.makeText(this.context, "Username and Password cannot be empty!", Toast.LENGTH_LONG).show()
            }
        }
