...
class RentalDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle("Car Rental Details")
        ...
        b.btnKonfirmasiRental.setOnClickListener {
            AlertDialog.Builder(this)
                ...
                .setMessage("Do you want to confirm that the car is running?")
...
//        }
        ...
        b.btnKonfirmasiPengembalian.setOnClickListener {
            AlertDialog.Builder(this)
                .setTitle("Warning!")
                .setIcon(R.drawable.warning)
                .setMessage("Do you want to confirm the car is back?")
                .setPositiveButton("Yes", DialogInterface.OnClickListener { dialogInterface, i ->
                    var paket : Bundle? = intent.extras
        ...
        FirebaseFirestore.getInstance().collection("rental").document(paket?.getString("idR").toString())
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.detailHargaSopir.setText("KSH."+st10)
        ...
        FirebaseFirestore.getInstance().collection("mobil").document(paket?.getString("idM").toString())
            ...
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    b.detailHarga.setText(" Rental Price KSH. "+st4)
                    b.detailHargaRental.setText("KSH. "+st4)
                } else {
                    // Dokumen tidak ditemukan
                }
            }
    ...
    fun batalkan() {
        AlertDialog.Builder(this)
            .setTitle("Remove Rental!")
            .setIcon(R.drawable.warning)
            .setMessage("Do you want to cancel this car rental?")
            .setPositiveButton("Yes", DialogInterface.OnClickListener { dialogInterface, i ->
                var paket : Bundle? = intent.extras
