        ...
        b.btnKirim.setOnClickListener {
            if (b.insPembayaran.selectedItem.toString().equals("Lunas")) {
                ...
                AlertDialog.Builder(v.context)
                    ...
                    .setMessage("Customer hasn't paid in full yet, can't confirm the car is running?")
    ...
    fun bayar() {
        ...
        FirebaseFirestore.getInstance().collection("rental")
            ...
            .addOnSuccessListener {
                Toast.makeText(v.context, "Successfully confirmed that the car is running!", Toast.LENGTH_SHORT).show()
